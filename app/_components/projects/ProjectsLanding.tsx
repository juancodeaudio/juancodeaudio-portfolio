      ...
      <div className="flex flex-col md:flex-row gap-6 md:gap-16 mb-28 items-center">
        ...
        <div className="flex gap-6">
          <a href="https://www.linkedin.com/in/juancodeaudio/" target="_blank">
            <Button ariaLabel="LinkedIn" buttonColor="light" variant="flat" hoverColor="bg-foreground" size="sm"><FaLinkedin className="h-6 w-6 inline" /></Button>
          </a>
          <a href="https://github.com/juancodeaudio" target="_blank">
            <Button ariaLabel="Github" buttonColor="light" variant="flat" hoverColor="bg-foreground" size="sm"><FaGithub className="h-6 w-6 inline" /></Button>
          </a>
        </div>
      </div>
    </section>
